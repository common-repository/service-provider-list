(function ($) {
	...
	$(
		function () {
			...
			if ($( '.rcode-order#sortable-table' ).length > 0) {
				$( '.rcode-order#sortable-table tbody' ).sortable(
					{
						axis: 'y',
						...
						update: function (event, ui) {
							...
							var data = {
								action: 'service_member_update_post_order',
								postType: $( this ).attr( 'data-post-type' ),
								order: theOrder,
								nonce: $( '#rcode-order' ).val()
							};
